            ...
            <div class="list-profile">
                <form class="profile" action="" method="POST" enctype="multipart/form-data">
                    <div class="item-img">
                        ...
                        <?php } else { ?>
                            <img src="../../img/noprofile.jpg" height="100" width="120">
                        <?php } ?>
                        <div class="upload">
                            <input type="file" name="profile" accept=".jpg">
                        </div>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        <input type="text" name="prodi" value="<?php echo $p->NAMA_PRODI ?>">
                    </div>
                    <div class="item">
                        <input type="email" name="email" value="<?php echo $a->EMAIL ?>">
                    </div>
                </form>
                <!-- <?php
