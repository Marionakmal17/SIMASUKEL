...
if (!empty($keyword)) {
    ...
    $query = "SELECT * FROM surat WHERE ID_JENIS = 'J0002' AND PENGIRIM = '$username' ORDER BY ID_SURAT DESC";
    $surat = mysqli_query($link, $query);
}
?>
    ...
    <div class="container">
        <aside>
            ...
            <a href="ketuaDash.php">
                ...
                <a href="ketuasuratKeluar.php" class="active">
                ...
                <div class="item">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $surat = mysqli_query($link, "SELECT * FROM surat WHERE ID_JENIS = 'J0002' AND PENERIMA = '$username' ORDER BY ID_SURAT DESC");
                                ...
                                while ($row = mysqli_fetch_array($surat)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#?id=<?php echo $row['ID_SURAT'] ?>">Unduh</a>
