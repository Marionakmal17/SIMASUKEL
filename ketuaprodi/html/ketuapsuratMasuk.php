...
if (!empty($keyword)) {
    $query = "SELECT * FROM surat WHERE ID_JENIS = 'J0001' AND (NO_SURAT LIKE '%$keyword%' OR TGL_TERIMA LIKE '%$keyword%' OR PERIHAL LIKE '%$keyword%') AND PENERIMA = '$username' ORDER BY ID_SURAT DESC";
    $surat = mysqli_query($link, $query);
} else {
    $query = "SELECT * FROM surat WHERE ID_JENIS = 'J0001' AND PENERIMA = '$username' ORDER BY ID_SURAT DESC";
    $surat = mysqli_query($link, $query);
}
?>
...
<head>
    ...
    <title>Surat Masuk - SI Surat Masuk dan Keluar</title>
</head>
    ...
    <div class="container">
        <aside>
            ...
            <a href="ketuaDash.php">
                ...
                <a href="ketuasuratMasuk.php" class="active">
                ...
                <div class="item">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $surat = mysqli_query($link, "SELECT * FROM surat WHERE ID_JENIS = 'J0001' AND PENERIMA = '$username' ORDER BY ID_SURAT DESC");
