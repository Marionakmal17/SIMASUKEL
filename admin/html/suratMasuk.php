...
if (!empty($keyword)) {
    $surat = mysqli_query($link, "SELECT * FROM surat WHERE ID_JENIS = 'J0001' AND (NO_SURAT LIKE '%$keyword%' OR TGL_TERIMA LIKE '%$keyword%' OR PENERIMA LIKE '%$keyword%' OR PERIHAL LIKE '%$keyword%') ORDER BY ID_SURAT DESC");
} else {
    $surat = mysqli_query($link, "SELECT * FROM surat WHERE ID_JENIS = 'J0001' ORDER BY ID_SURAT DESC");
}
// Mencari dan menampilkan data surat
?>
    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="suratMasuk.php" class="active">
                                ...
                                while ($row = mysqli_fetch_array($surat)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="hapus.php?idSM=<?php echo $row['ID_SURAT'] ?>"
